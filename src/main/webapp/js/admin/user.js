...
function updateUserCallback(data, status, id, newUsername, newNickname, newBalance, newRole) {
    if (data.result == 'success') {
...
$('#btnUpdateUser').click(function () {
    ...
    $.post(updateUserAPI, postData, function (data, status) {
        updateUserCallback(data, status, id, newUsername, newNickname, newBalance, newRole);
    }).fail(function (xhr, status, error) {
        updateUserCallback(tryJSONParse(xhr.responseText), error, id, newUsername, newNickname, newBalance, newRole);
    });
});
